...
/// Search your Diver library or browse recent links.
...
struct SearchLinksIntent: AppIntent, WidgetConfigurationIntent {
    static var title: LocalizedStringResource = "Search Diver Links (Fuzzy Match)"
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<LinkEntity> & ProvidesDialog & ShowsSnippetView {
        ...
        guard let selected = userSelectedResult else {
            ...
            throw NSError(
                domain: "com.secretatomics.Diver",
                code: 404,
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack {
                ...
                Link(destination: URL(string: "diver://open?id=\(id)")!) {
                    HStack(spacing: 4) {
                        Text("View in Diver")
