...
/// Custom ItemRead schema that provides default values for optional fields
/// instead of returning None. This improves Swift client ergonomics.
public struct ItemRead: Codable, Hashable, Sendable {
