        ...
        VStack(spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                OnboardingBullet(
                    ...
                    descriptionText: "CLaRa 7B and FastVLM 1.5B run here, delivering richer summaries than the on-device models."
                )
                OnboardingBullet(
                    icon: "rotate.3d",
                    color: .orange,
                    title: "3D Scene Generation",
                    descriptionText: "Convert any capture into a 3D Gaussian Splat viewable in AR on your iPhone."
                )
                OnboardingBullet(
                    icon: "lock.shield.fill",
                    color: .green,
                    title: "Stays on Your Network",
                    descriptionText: "All traffic uses TLS 1.3. Nothing leaves your home. No accounts, no cloud."
                )
                OnboardingBullet(
                    icon: "gearshape.fill",
                    color: .gray,
                    title: "Fully in Your Control",
                    descriptionText: "Appears in System Settings › Login Items. Disable it anytime in one click."
                )
            }
            .padding(.horizontal, 32)
            .padding(.vertical, 20)
