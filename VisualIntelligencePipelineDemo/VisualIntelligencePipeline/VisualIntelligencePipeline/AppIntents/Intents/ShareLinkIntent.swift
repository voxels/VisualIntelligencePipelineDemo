...
/// Share a wrapped Visual Intelligence link from the current page (share sheet context).
...
struct ShareLinkIntent: AppIntent {
    static var title: LocalizedStringResource = "Share Link"
    static var description = IntentDescription("Wrap and share the current page as a Visual Intelligence link.")
    ...
    func perform() async throws -> some IntentResult & ReturnsValue<String> & ProvidesDialog & ShowsSnippetView {
        ...
        // Retrieve link secret from keychain
        guard
