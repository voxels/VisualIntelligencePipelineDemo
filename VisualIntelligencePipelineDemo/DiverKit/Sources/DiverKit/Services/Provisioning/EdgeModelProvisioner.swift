...
public actor EdgeModelProvisioner {
    ...
    // Note: provisionFastVLM7B() removed — apple/FastVLM-7B uses llava_qwen2 architecture
    // which is unsupported by mlx_vlm.convert. No MLX-community port exists.
    // The daemon uses mlx-community/FastVLM-0.5B-bf16 via HuggingFace Hub instead.
