...
//  DiverUI
//
//  Cross-platform list of UserConcept items with weight display.
//  Identical logic to the original iOS version; now public and shared.
//
...
public struct ConceptListView: View {
